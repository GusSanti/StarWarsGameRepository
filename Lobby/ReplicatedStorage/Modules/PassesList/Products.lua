...
local Products = {
	...
	[3605584359] = function(ReceiptInfo, Player) -- Fawn
		print('non shiny')
	...
	[3605584599] = function(ReceiptInfo, Player) -- Fawn(SHINY)
	...
	[3605584692] = function(ReceiptInfo, Player) -- Anakin
	...
	[3605584750] = function(ReceiptInfo, Player) -- Dartwader
		...
		Player.Items["Fortunate Crystal"].Value += 5
		return true
	end,

	[3605584862] = function(ReceiptInfo, Player) -- Force Fortune Pack
	...
	[3605584914] = function(ReceiptInfo, Player) -- Droid Starter Kit
	...
	[3605584984] = function(ReceiptInfo, Player) -- Wisest Jedai's Blessing
	...
	[3605585043] = function(ReceiptInfo, Player) -- Jedi Master Bundle
	...
	[3605585152] = function(RecieptInfo, player) -- battle pass
	...
	[3605585374] = function(RecieptInfo, player) -- 1
		player.BattlepassData.Tier.Value += 1
		return true
	end,

	[3605585472] = function(RecieptInfo, player) -- 5
		player.BattlepassData.Tier.Value += 5
		return true
	end,

	[3605588096] = function(RecieptInfo, player) -- 10
		player.BattlepassData.Tier.Value += 10
		return true
	end,

	-----------------------
	[3605588733] = function(ReceiptInfo, player)
		player:FindFirstChild("DailyRewards"):FindFirstChild("LastClaimTime").Value = 0
		return true
	end,

	[3605588998] = function(ReceiptInfo, player) -- Battlepass Bundle
		player.BattlepassData.Premium.Value = true
	...
	[3605589074] = function(RecieptInfo, player) -- clan token refill thing
		player.ClanData.CreationTokens.Value += 1

		return true
	end,

	[3605589184] = function(ReceiptInfo, Player)	--Mini Pack
		Player.Gems.Value += 500
		return true
	end,
	
	[3605589312] = function(ReceiptInfo, Player)	--Small Pack
		Player.Gems.Value += 2000

		return true
	end,
	[3605589394] = function(ReceiptInfo, Player)	--Medium Pack
		Player.Gems.Value += 3000

		return true
	end,
	[3605589677] = function(ReceiptInfo, Player)	--Large Pack
		Player.Gems.Value += 5000

		return true
	end,
	[3605589770] = function(ReceiptInfo, Player)	--Huge Pack
		Player.Gems.Value += 20000

		return true
	end,
	[3605589883] = function(ReceiptInfo, Player)	--Massive Pack
		Player.Gems.Value += 50000

		return true
	end,
	[3605589986] = function(ReceiptInfo, Player)	--Colossal Pack
		Player.Gems.Value += 100000

		return true
	end,

	[3605590098] = function(ReceiptInfo, Player)    --Fortunate Crystal
	...
	[3605590165] = function(ReceiptInfo, Player)    --Fortunate Crystal Bundle
	...
	[3605590234] = function(ReceiptInfo, Player)    --Lucky Crystal
	...
	[3605590313] = function(ReceiptInfo, Player)    -- Junk Offering Bundle
	...
	[3605590401] = function(ReceiptInfo, Player)    --Lucky Crystal Bundle
		local DefaultValue = Player.Items["Lucky Crystal"].Value
	...
	[3605590581] = function(ReceiptInfo, Player)    -- x2 Raid Luck Bundle
	...
	[3605590666] = function(ReceiptInfo, Player)    -- x3 Raid Luck Crystal
	...
	[3605590908] = function(ReceiptInfo, Player) -- x1 WillPowers
	...
	[3605591017] = function(ReceiptInfo, Player) -- x10 WillPowers
		Player["TraitPoint"].Value += 20

		return true
	end,
	[3605591058] = function(ReceiptInfo, Player) -- x25 WillPowers
		Player["TraitPoint"].Value += 50

		return true
	end,
	[3605591127] = function(ReceiptInfo, Player) -- x50 WillPowers
		Player["TraitPoint"].Value += 100
	...
	[3605589177] = function(ReceiptInfo, Player) -- x100 WillPowers
		Player["TraitPoint"].Value += 250
		return true
	end,
	
	[3605589216] = function(ReceiptInfo, Player) -- Refill Raid Attempts
	...
	[3605589693] = function(ReceiptInfo, Player) --Starter Pack
	...
	[3605589841] = function(ReceiptInfo, Player)	--2x Coin Boost [1HR]
	...
	[3605589959] = function(ReceiptInfo, Player)	--2x XP Boost [1HR]
	...
	[3605590030] = function(ReceiptInfo,Player)	--Starter Bundle
	...
	[3605590114] = function(ReceiptInfo,Player)	--Supreme Bundle
		Player.OwnGamePasses["Ultra VIP"].Value = true
		Player.OwnGamePasses["3x Speed"].Value = true
		Player.OwnGamePasses["Supreme Bundle"].Value = true
		Player.Gems.Value += 50000
	...
	[3605590176] = function(ReceiptInfo,Player) -- Luck Bundle
		Player.Gems.Value += 1000
		Player.Items['Lucky Crystal'].Value += 2
		Player.Items['Fortunate Crystal'].Value += 2
		Player.LuckySpins.Value += 5
	...
	[3605590243] = function(ReceiptInfo, Player) -- 4-Leaf Bundle
		Player.Gems.Value += 2500
		Player.TraitPoint.Value += 100
		-- 5 lucky summons
		Player.LuckySpins.Value += 5
	...
	[3605590340] = function(ReceiptInfo, Player) -- x1 Lucky Summon
		Player.LuckySpins.Value += 1

		return true
	end,

	[3605590397] = function(ReceiptInfo, Player) -- x5 Lucky Summon
		Player.LuckySpins.Value += 5

		return true
	end,

	[3605590499] = function(ReceiptInfo, Player) -- x10 Lucky Summon
		Player.LuckySpins.Value += 10

		return true
	end,

	[3605590558] = function(ReceiptInfo, Player) -- x20 Lucky Summon
	...
	[3605590636] = function(ReceiptInfo, Player) -- 25 Junk Trader Points
		local userId = Player.UserId
		local amount = ReceiptInfo.CurrencySpent
	...
	[3605590701] = function(ReceiptInfo, Player) -- 50 Junk Trader Points
		local userId = Player.UserId
		local amount = ReceiptInfo.CurrencySpent
		local itemType = "Currency"
	...
	[3605590778] = function(ReceiptInfo, Player)
			--[[
	...
	[3605590934] = function(ReceiptInfo, Player) -- Lucky Willpower
		--warn("Firing", Player)
		--warn(Player)
		--local userId = Player.UserId
		--local amount = 99
	...
	[3605591010] = function(ReceiptInfo, Player) -- Lucky Willpower Bundle
		--warn("Firing", Player)
		--warn(Player)
		--local userId = Player.UserId
		--local amount = 99
